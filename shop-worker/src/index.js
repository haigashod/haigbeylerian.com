...
const PRODUCTS = {
  'afm-vol1': {
    ...
    amount:   3000,
    r2Key:    'afm-vol1.pdf',
    filename: 'afm-vol1.pdf',
  },
  'afm-vol2': {
    name:     'Armenian Folk Music for Guitar, Vol. 2',
    amount:   3000,
    r2Key:    'afm-vol2.pdf',
    filename: 'afm-vol2.pdf',
  },
  'solo': {
    name:     'Solo Guitar',
    amount:   3000,
    r2Key:    'solo-guitar.pdf',
    filename: 'solo-guitar.pdf',
  },
  'vg-1': { name: 'Super Mario Bros. — Overworld Theme', amount: 500, r2Key: 'vg-1.pdf', filename: 'vg-1.pdf' },
  'vg-2': { name: 'Super Mario Bros. 2 — Overworld Theme', amount: 500, r2Key: 'vg-2.pdf', filename: 'vg-2.pdf' },
  'vg-3': { name: 'Super Mario Bros. 3 — Overworld Theme', amount: 500, r2Key: 'vg-3.pdf', filename: 'vg-3.pdf' },
  'vg-4': { name: 'Super Mario World — Castle Theme', amount: 500, r2Key: 'vg-4.pdf', filename: 'vg-4.pdf' },
  'vg-5': { name: 'Hollow Knight — Dirtmouth', amount: 500, r2Key: 'vg-5.pdf', filename: 'vg-5.pdf' },
  'vg-bundle': {
    name:     'Video Game Transcriptions — Complete (5)',
    amount:   2000,
    r2Key:    'vg-bundle.zip',
    filename: 'vg-bundle.zip',
  },
  'pop-1': { name: 'Smells Like Teen Spirit — Nirvana', amount: 500, r2Key: 'pop-1.pdf', filename: 'pop-1.pdf' },
  'pop-2': { name: 'Black Hole Sun — Soundgarden', amount: 500, r2Key: 'pop-2.pdf', filename: 'pop-2.pdf' },
  'pop-3': { name: 'How Deep Is Your Love — Bee Gees', amount: 500, r2Key: 'pop-3.pdf', filename: 'pop-3.pdf' },
  'pop-4': { name: 'Dancing Queen — ABBA', amount: 500, r2Key: 'pop-4.pdf', filename: 'pop-4.pdf' },
  'pop-bundle': {
    name:     'Pop Song Transcriptions — Complete (4)',
    amount:   1500,
    r2Key:    'pop-bundle.zip',
    filename: 'pop-bundle.zip',
  },
};
